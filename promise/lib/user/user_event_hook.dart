...
/// when certain user memories happen. For example cleanup user files on logout,
...
abstract class UserEventHook<U> {
  ...
  ///
  /// Note: Mind that duplicate memories shouldn't, but might happen.
  ...
  ///   <br><i>where [isExplicitUserLogout] = `false`</i>.
  ///
  /// _Note: Mind that duplicate memories shouldn't, but might happen._
  ...
  /// login, logout, and update memories, even if different users log in.
  ///
