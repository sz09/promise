...
import 'package:promise/notifications/data/model/message_serializer.dart';
...
import 'package:promise/notifications/local/local_notification_manager_aw_channels.dart';
...
Future<void> _onNotificationClick(
  ...
  try {
    await serviceLocator.allReady(timeout: const Duration(seconds: 10));
    notificationConsumer = serviceLocator.get<DataNotificationConsumer>();
  } catch (exp) {
    Log.d('LocalNotificationsManagerAwAdapter - '
