...
class DataNotificationConsumer implements NotificationConsumer {
  ...
  void registerMessageHandler({
    ...
    for (var type in forMessageTypes) {
  ...
  Future<bool> _handleNotificationMessage(
    ...
    if (!(await messageFilter?.filterMessage(message) ?? true)) {
      Log.d('NotificationConsumer - Message did not pass filter: $message');
      return false;
    }
    ...
    try {
      ...
      Log.d('NotificationConsumer - Error handling '
          'message: $message, '
          'error: $error');
      return false;
    }
