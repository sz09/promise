...
import 'package:promise/notifications/data/model/message.dart' as model;
import 'package:promise/notifications/data/model/remote_message_extension.dart';
...
import 'package:promise/notifications/local/android_notification_ids.dart';
...
class FcmNotificationsListener {
  ...
  Future<void> setupPushNotifications() async {
    ...
    // Notification click listener when app is terminated and memoryually opened
  ...
  R? ifUserAuthorized<R>(R? Function() action) {
    if (_userAuthorized) {
      ...
      Log.d('FCM - Message missed. User unauthorized.');
      return null;
    }
  }
  ...
  /// Handle the click memory on notification when app is in any state
  Future<void> _onAppOpenedFromMessage(
    RemoteMessage? message,
    bool fromTerminatedState,
  ) async {
    if (message != null) {
      Log.d('FCM - OnAppOpenedFromNotification - '
...
Future<void> backgroundMessageHandler(RemoteMessage message) async {
  Log.d('FCM - Background message: ${message.print()}. '
